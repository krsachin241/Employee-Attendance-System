...
function MarkAttendance() {
  ...
  return (
    ...
    >
      <div style={{ width: '100%', maxWidth: 600, margin: '0 auto', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
        <h2
          style={{
            fontSize: 26,
            fontWeight: 800,
        ...
        <p style={{ color: '#888', marginBottom: 28, textAlign: 'center', width: '100%' }}>{dateStr} &bull; {timeStr}</p>
